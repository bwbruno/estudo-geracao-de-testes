...
public class FuncionarioService_ESTest extends FuncionarioService_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Funcionario funcionario0 = new Funcionario("Coordenador", "Coordenador", (-2586.23), (-1771));
      funcionarioService0.adicionar(funcionario0);
      assertEquals("Coordenador", funcionario0.getNome());
  }
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        funcionarioService0.remover(",fg");
        fail("Expecting exception: NullPointerException");
  ...
  public void test05()  throws Throwable  {
      LinkedList<Funcionario> linkedList0 = new LinkedList<Funcionario>();
      FuncionarioDAO funcionarioDAO0 = mock(FuncionarioDAO.class, new ViolatedAssumptionAnswer());
      doReturn(linkedList0, linkedList0, (List<Funcionario>) null).when(funcionarioDAO0).todos();
      FuncionarioService funcionarioService0 = new FuncionarioService(funcionarioDAO0);
      funcionarioService0.buscarPorNome("Funcion\u00E1rios salvos no arquivo JSON.");
      funcionarioService0.todos();
      // Undeclared exception!
      try { 
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        funcionarioService0.buscarPorNome("Cargo inv\u00E1lido: ");
        fail("Expecting exception: NullPointerException");
  ...
  public void test09()  throws Throwable  {
      Funcionario funcionario0 = new Funcionario("Analista", "Analista", 1659, 1659);
      FuncionarioService funcionarioService0 = new FuncionarioService((FuncionarioDAO) null);
      // Undeclared exception!
      try { 
        funcionarioService0.adicionar(funcionario0);
  ...
  public void test11()  throws Throwable  {
      FuncionarioDAO funcionarioDAO0 = mock(FuncionarioDAO.class, new ViolatedAssumptionAnswer());
      FuncionarioService funcionarioService0 = new FuncionarioService(funcionarioDAO0);
      funcionarioService0.remover("Erro ao salvar o arquivo JSON: ");
  }
}
